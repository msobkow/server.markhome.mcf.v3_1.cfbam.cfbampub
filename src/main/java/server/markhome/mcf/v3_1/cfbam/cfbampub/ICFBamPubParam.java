// Description: Java 25 public interface for a Param record implementation
...
/**
 *	ICFBamPubParam persistence instances have CodeVis Public, meaning that any user interface or referencing schema can access it.
 */
public interface ICFBamPubParam
{
	...
	public void setPubParam( ICFBamPubParam src );
	public void set( ICFBamPubParamH src );
	public void setPubParam( ICFBamPubParamH src );
