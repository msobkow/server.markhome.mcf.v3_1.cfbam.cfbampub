 ...
 */
public interface ICFBamPubPopTopDep
	extends ICFBamPubPopDep
{
	...
	public ICFBamPubRelation get$OptionalOrRequired$ContainerContRelation();
	...
	public List<ICFBamPubPopSubDep1> get$OptionalOrRequired$ComponentsPopDep();
