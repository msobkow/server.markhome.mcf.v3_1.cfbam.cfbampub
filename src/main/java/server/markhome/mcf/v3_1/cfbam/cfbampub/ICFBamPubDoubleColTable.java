...
// Description: Java 25 public DbIO interface for DoubleCol.
...
/*
 *	CFBamPubDoubleColTable public database interface for DoubleCol has CodeVis Public, meaning that any user interface or referencing schema can access it.
 */
public interface ICFBamPubDoubleColTable
{
