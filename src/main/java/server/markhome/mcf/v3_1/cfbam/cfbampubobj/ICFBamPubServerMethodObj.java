// Description: Java 25 Object interface for CFBamPub ServerMethod.
...
public interface ICFBamPubServerMethodObj
	extends ICFBamPubScopeObj
{
	/**
	 *	Get the current edition of this ServerMethod instance as a ICFBamPubServerMethodEditObj.
	 *
	 *	@return	The ICFBamPubServerMethodEditObj edition of this instance.
	 */
	ICFBamPubServerMethodEditObj getEditAsServerMethod();

	/**
	 *	Get the ICFBamPubServerMethodTableObj table cache which manages this instance.
	 *
	 *	@return	ICFBamPubServerMethodTableObj table cache which manages this instance.
	 */
	ICFBamPubServerMethodTableObj getServerMethodTable();

	/**
	 *	Get the ICFBamPubServerMethod instance which currently backs this instance.
	 *	<p>
	 *	This value <i>will</i> change for read-only instances, so you should
	 *	not hold on to the value as a reference anywhere outside the current call stack.
	 *
	 *	@return	ICFBamPubServerMethod instance which currently backs this object.
	 */
	ICFBamPubServerMethod getServerMethodRec();
	...
	/**
	 *	Get the array of $optionalorrequired$ ICFBamPubParamObj array of instances referenced by the Params key.
	 *
	 *	@return	The $optionalorrequired$ ICFBamPubParamObj[] array of instances referenced by the Params key.
	 */
	 ...
	 *	@return	The $optionalorrequired$ ICFBamPubParamObj[] array of instances referenced by the Params key.
	 */
	List<ICFBamPubParamObj> get$OptionalOrRequired$ComponentsParams( boolean forceRead );
