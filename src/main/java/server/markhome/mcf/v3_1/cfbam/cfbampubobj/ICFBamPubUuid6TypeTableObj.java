...
public interface ICFBamPubUuid6TypeTableObj
{
	 ...
	 */
	ICFBamPubUuid6TypeObj readUuid6Type( ICFLibKeyHash256 pkey );
	...
	ICFBamPubUuid6TypeObj readCachedUuid6Type( ICFLibKeyHash256 pkey );

	public void reallyDeepDisposeUuid6Type( ICFBamPubUuid6TypeObj obj );

	void deepDisposeUuid6Type( ICFLibKeyHash256 pkey );

	/**
	 *	Internal use only.
	 */
	ICFBamPubUuid6TypeObj lockUuid6Type( ICFLibKeyHash256 pkey );
