...
// Description: Java 25 public DbIO interface for TZTimestampType.
...
/*
 *	CFBamPubTZTimestampTypeTable public database interface for TZTimestampType has CodeVis Public, meaning that any user interface or referencing schema can access it.
 */
public interface ICFBamPubTZTimestampTypeTable
{
	 ...
	 *	@return	The refreshed record after it has been moved
	 */
	public ICFBamPubTZTimestampType pubmoveRecDown( ICFSecPubAuthorization Authorization,
		CFLibDbKeyHash256 Id,
		int revision );
}
