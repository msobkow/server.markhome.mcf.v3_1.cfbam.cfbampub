// Description: Java 25 public interface for a UInt32Type record implementation
...
/**
 *	ICFBamPubUInt32Type persistence instances have CodeVis Public, meaning that any user interface or referencing schema can access it.
 */
public interface ICFBamPubUInt32Type extends ICFBamPubUInt32Def
{
