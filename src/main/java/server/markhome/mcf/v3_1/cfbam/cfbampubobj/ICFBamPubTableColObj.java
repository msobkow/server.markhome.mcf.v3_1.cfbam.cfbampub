// Description: Java 25 Object interface for CFBamPub TableCol.
...
public interface ICFBamPubTableColObj
	extends ICFBamPubValueObj
{
	/**
	 *	Get the current edition of this TableCol instance as a ICFBamPubTableColEditObj.
	 *
	 *	@return	The ICFBamPubTableColEditObj edition of this instance.
	 */
	ICFBamPubTableColEditObj getEditAsTableCol();

	/**
	 *	Get the ICFBamPubTableColTableObj table cache which manages this instance.
	 *
	 *	@return	ICFBamPubTableColTableObj table cache which manages this instance.
	 */
	ICFBamPubTableColTableObj getTableColTable();

	/**
	 *	Get the ICFBamPubTableCol instance which currently backs this instance.
	 *	<p>
	 *	This value <i>will</i> change for read-only instances, so you should
	 *	not hold on to the value as a reference anywhere outside the current call stack.
	 *
	 *	@return	ICFBamPubTableCol instance which currently backs this object.
	 */
