// Description: Java 25 Object interface for CFBamPub DelSubDep1.
...
public interface ICFBamPubDelSubDep1Obj
	extends ICFBamPubDelDepObj
{
	/**
	 *	Get the current edition of this DelSubDep1 instance as a ICFBamPubDelSubDep1EditObj.
	 *
	 *	@return	The ICFBamPubDelSubDep1EditObj edition of this instance.
	 */
	ICFBamPubDelSubDep1EditObj getEditAsDelSubDep1();

	/**
	 *	Get the ICFBamPubDelSubDep1TableObj table cache which manages this instance.
	 *
	 *	@return	ICFBamPubDelSubDep1TableObj table cache which manages this instance.
	 */
	ICFBamPubDelSubDep1TableObj getDelSubDep1Table();

	/**
	 *	Get the ICFBamPubDelSubDep1 instance which currently backs this instance.
	 *	<p>
	 *	This value <i>will</i> change for read-only instances, so you should
	 *	not hold on to the value as a reference anywhere outside the current call stack.
	 *
	 *	@return	ICFBamPubDelSubDep1 instance which currently backs this object.
	 */
