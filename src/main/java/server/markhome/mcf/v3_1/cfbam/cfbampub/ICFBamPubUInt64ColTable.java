...
// Description: Java 25 public DbIO interface for UInt64Col.
...
/*
 *	CFBamPubUInt64ColTable public database interface for UInt64Col has CodeVis Public, meaning that any user interface or referencing schema can access it.
 */
public interface ICFBamPubUInt64ColTable
{
	 ...
	 *	@return	The refreshed record after it has been moved
	 */
	public ICFBamPubUInt64Col pubmoveRecDown( ICFSecPubAuthorization Authorization,
		CFLibDbKeyHash256 Id,
		int revision );
}
