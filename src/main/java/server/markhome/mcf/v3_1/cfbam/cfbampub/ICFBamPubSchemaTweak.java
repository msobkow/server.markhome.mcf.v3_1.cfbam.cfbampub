// Description: Java 25 public interface for a SchemaTweak record implementation
...
/**
 *	ICFBamPubSchemaTweak persistence instances have CodeVis Public, meaning that any user interface or referencing schema can access it.
 */
public interface ICFBamPubSchemaTweak extends ICFBamPubTweak
{
	...
	public void setPubSchemaTweak( ICFBamPubSchemaTweak src );
	public void set( ICFBamPubTweakH src );
	public void setPubSchemaTweak( ICFBamPubSchemaTweakH src );
}
