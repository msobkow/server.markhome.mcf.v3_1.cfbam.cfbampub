// Description: Java 25 Object interface for CFBamPub Value.
...
public interface ICFBamPubValueObj
	extends ICFLibAnyObj
{
	/**
	 *	Initially, the class code for an object is ICFBamPubValue.CLASS_CODE, but the Obj layer relies on class code translation to map those
	 ...
	 *
	 *	@return	CFBamPubValueObj instance which should be subsequently referenced.
	 */
	ICFBamPubValueObj realise();
	 ...
	 *
	 *	@return	ICFBamPubValueObj the reference to the cached or read (realised) instance.
	 */
	ICFBamPubValueObj read();
	 ...
	 *	@return	ICFBamPubValueObj the reference to the cached or read (realised) instance.
	 */
	ICFBamPubValueObj read( boolean forceRead );

	/**
	 *	Move this object up in the chain and refresh the cache.
	 *
	 *	@return	ICFBamPubValueObj the reference to the moved and refreshed instance.
	 */
	ICFBamPubValueObj moveUp();
	 ...
	 *	@return	ICFBamPubValueObj the reference to the moved and refreshed instance.
	 */
	ICFBamPubValueObj moveDown();

	/**
	 *	Initialize and return a locked edition of this Value instance.
	 *
	 *	@return	The newly locked ICFBamPubValueEditObj edition of this instance.
	 */
	ICFBamPubValueEditObj beginEdit();
	 ...
	 *
	 *	@return	The ICFBamPubValueEditObj edition of this instance.
	 */
	ICFBamPubValueEditObj getEdit();

	/**
	 *	Get the current edition of this Value instance as a ICFBamPubValueEditObj.
	 *
	 *	@return	The ICFBamPubValueEditObj edition of this instance.
	 */
	ICFBamPubValueEditObj getEditAsValue();

	/**
	 *	Get the ICFBamPubValueTableObj table cache which manages this instance.
	 *
	 *	@return	ICFBamPubValueTableObj table cache which manages this instance.
	 */
	ICFBamPubValueTableObj getValueTable();
	...
	/**
	 *	Get the ICFBamPubValue instance which currently backs this instance.
	 *	<p>
	 *	This value <i>will</i> change for read-only instances, so you should
	 *	not hold on to the value as a reference anywhere outside the current call stack.
	 *
	 *	@return	ICFBamPubValue instance which currently backs this object.
	 */
	ICFBamPubValue getRec();

	/**
	 *	Internal use only.
	 */
	void setRec( ICFBamPubValue value );
	...
	/**
	 *	Get the array of $optionalorrequired$ ICFBamPubTableColObj array of instances referenced by the RefTableCol key.
	 *
	 *	@return	The $optionalorrequired$ ICFBamPubTableColObj[] array of instances referenced by the RefTableCol key.
	 */
	 ...
	 *	@return	The $optionalorrequired$ ICFBamPubTableColObj[] array of instances referenced by the RefTableCol key.
	 */
	List<ICFBamPubTableColObj> get$OptionalOrRequired$ChildrenRefTableCol( boolean forceRead );

	/**
	 *	Get the array of $optionalorrequired$ ICFBamPubIndexColObj array of instances referenced by the RefIndexCol key.
	 *
	 *	@return	The $optionalorrequired$ ICFBamPubIndexColObj[] array of instances referenced by the RefIndexCol key.
	 */
	 ...
	 *	@return	The $optionalorrequired$ ICFBamPubIndexColObj[] array of instances referenced by the RefIndexCol key.
	 */
	List<ICFBamPubIndexColObj> get$OptionalOrRequired$ChildrenRefIndexCol( boolean forceRead );
