...
// Description: Java 25 public DbIO interface for TimestampCol.
...
/*
 *	CFBamPubTimestampColTable public database interface for TimestampCol has CodeVis Public, meaning that any user interface or referencing schema can access it.
 */
public interface ICFBamPubTimestampColTable
{
	 ...
	 *	@return	The refreshed record after it has been moved
	 */
	public ICFBamPubTimestampCol pubmoveRecDown( ICFSecPubAuthorization Authorization,
		CFLibDbKeyHash256 Id,
		int revision );
}
