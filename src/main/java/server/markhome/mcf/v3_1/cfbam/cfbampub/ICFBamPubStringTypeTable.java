...
// Description: Java 25 public DbIO interface for StringType.
...
/*
 *	CFBamPubStringTypeTable public database interface for StringType has CodeVis Public, meaning that any user interface or referencing schema can access it.
 */
public interface ICFBamPubStringTypeTable
{
	 ...
	 *	@return	The refreshed record after it has been moved
	 */
	public ICFBamPubStringType pubmoveRecDown( ICFSecPubAuthorization Authorization,
		CFLibDbKeyHash256 Id,
		int revision );
}
