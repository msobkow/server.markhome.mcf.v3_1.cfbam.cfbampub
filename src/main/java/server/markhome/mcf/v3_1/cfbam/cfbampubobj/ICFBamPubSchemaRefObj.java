// Description: Java 25 Object interface for CFBamPub SchemaRef.
...
public interface ICFBamPubSchemaRefObj
	extends ICFBamPubScopeObj
{
	/**
	 *	Move this object up in the chain and refresh the cache.
	 *
	 *	@return	ICFBamPubSchemaRefObj the reference to the moved and refreshed instance.
	 */
	ICFBamPubSchemaRefObj moveUp();
	 ...
	 *	@return	ICFBamPubSchemaRefObj the reference to the moved and refreshed instance.
	 */
	ICFBamPubSchemaRefObj moveDown();

	/**
	 *	Get the current edition of this SchemaRef instance as a ICFBamPubSchemaRefEditObj.
	 *
	 *	@return	The ICFBamPubSchemaRefEditObj edition of this instance.
	 */
	ICFBamPubSchemaRefEditObj getEditAsSchemaRef();

	/**
	 *	Get the ICFBamPubSchemaRefTableObj table cache which manages this instance.
	 *
	 *	@return	ICFBamPubSchemaRefTableObj table cache which manages this instance.
	 */
	ICFBamPubSchemaRefTableObj getSchemaRefTable();

	/**
	 *	Get the ICFBamPubSchemaRef instance which currently backs this instance.
	 *	<p>
	 *	This value <i>will</i> change for read-only instances, so you should
	 *	not hold on to the value as a reference anywhere outside the current call stack.
	 *
	 *	@return	ICFBamPubSchemaRef instance which currently backs this object.
	 */
