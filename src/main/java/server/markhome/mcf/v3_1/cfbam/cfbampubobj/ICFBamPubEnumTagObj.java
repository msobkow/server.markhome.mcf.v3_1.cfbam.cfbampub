// Description: Java 25 Object interface for CFBamPub EnumTag.
...
public interface ICFBamPubEnumTagObj
	extends ICFLibAnyObj
{
	/**
	 *	Initially, the class code for an object is ICFBamPubEnumTag.CLASS_CODE, but the Obj layer relies on class code translation to map those
	 ...
	 *
	 *	@return	CFBamPubEnumTagObj instance which should be subsequently referenced.
	 */
	ICFBamPubEnumTagObj realise();
	 ...
	 *
	 *	@return	ICFBamPubEnumTagObj the reference to the cached or read (realised) instance.
	 */
	ICFBamPubEnumTagObj read();
	 ...
	 *	@return	ICFBamPubEnumTagObj the reference to the cached or read (realised) instance.
	 */
	ICFBamPubEnumTagObj read( boolean forceRead );

	/**
	 *	Move this object up in the chain and refresh the cache.
	 *
	 *	@return	ICFBamPubEnumTagObj the reference to the moved and refreshed instance.
	 */
	ICFBamPubEnumTagObj moveUp();
	 ...
	 *	@return	ICFBamPubEnumTagObj the reference to the moved and refreshed instance.
	 */
	ICFBamPubEnumTagObj moveDown();

	/**
	 *	Initialize and return a locked edition of this EnumTag instance.
	 *
	 *	@return	The newly locked ICFBamPubEnumTagEditObj edition of this instance.
	 */
	ICFBamPubEnumTagEditObj beginEdit();
	 ...
	 *
	 *	@return	The ICFBamPubEnumTagEditObj edition of this instance.
	 */
	ICFBamPubEnumTagEditObj getEdit();

	/**
	 *	Get the current edition of this EnumTag instance as a ICFBamPubEnumTagEditObj.
	 *
	 *	@return	The ICFBamPubEnumTagEditObj edition of this instance.
	 */
	ICFBamPubEnumTagEditObj getEditAsEnumTag();

	/**
	 *	Get the ICFBamPubEnumTagTableObj table cache which manages this instance.
	 *
	 *	@return	ICFBamPubEnumTagTableObj table cache which manages this instance.
	 */
	ICFBamPubEnumTagTableObj getEnumTagTable();
	...
	/**
	 *	Get the ICFBamPubEnumTag instance which currently backs this instance.
	 *	<p>
	 *	This value <i>will</i> change for read-only instances, so you should
	 *	not hold on to the value as a reference anywhere outside the current call stack.
	 *
	 *	@return	ICFBamPubEnumTag instance which currently backs this object.
	 */
	ICFBamPubEnumTag getRec();

	/**
	 *	Internal use only.
	 */
	void setRec( ICFBamPubEnumTag value );
	 ...
	 *	@return	ICFBamPubEnumTag instance which currently backs this object.
	 */
	ICFBamPubEnumTag getEnumTagRec();
