// Description: Java 25 Object interface for CFBamPub Relation.
...
public interface ICFBamPubRelationObj
	extends ICFBamPubScopeObj
{
	/**
	 *	Get the current edition of this Relation instance as a ICFBamPubRelationEditObj.
	 *
	 *	@return	The ICFBamPubRelationEditObj edition of this instance.
	 */
	ICFBamPubRelationEditObj getEditAsRelation();

	/**
	 *	Get the ICFBamPubRelationTableObj table cache which manages this instance.
	 *
	 *	@return	ICFBamPubRelationTableObj table cache which manages this instance.
	 */
	ICFBamPubRelationTableObj getRelationTable();

	/**
	 *	Get the ICFBamPubRelation instance which currently backs this instance.
	 *	<p>
	 *	This value <i>will</i> change for read-only instances, so you should
	 *	not hold on to the value as a reference anywhere outside the current call stack.
	 *
	 *	@return	ICFBamPubRelation instance which currently backs this object.
	 */
