// Description: Java 25 public interface for a Table history object
...
/**
 *	ICFBamPubTableH provides access to public history records matching the CFBamPubTable object change history.
 */
public interface ICFBamPubTableH extends ICFBamPubScopeH
{
