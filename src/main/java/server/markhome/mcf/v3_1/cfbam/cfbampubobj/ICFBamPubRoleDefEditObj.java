// Description: Java 25 Public Instance Edit Object interface for CFBam RoleDef.
...
public interface ICFBamPubRoleDefEditObj
	extends ICFBamPubRoleDefObj
{
	/*
	 *	Get the original for this edition as the base type for the class hierarchy.
	 *
	 *	@return The original, non-modifiable instance as a base ICFBamPubRoleDefObj.
	 */
	ICFBamPubRoleDefObj getOrig();

	/*
	 *	Get the original for this edition cast as the specified type.
	 *
	 *	@return The original, non-modifiable instance cast to a ICFBamPubRoleDefObj.
	 */
	ICFBamPubRoleDefObj getOrigAsRoleDef();
	 ...
	 */
	ICFBamPubRoleDefObj create();

	/*
	 *	Update the instance.
	 */
	ICFBamPubRoleDefEditObj update();

	/*
	 *	Delete the instance.
	 */
	ICFBamPubRoleDefEditObj deleteInstance();
	...
	/**
	 *	Get the ICFBamPubScopeObj instance referenced by the ScopeDef key.
	 *
	 *	@return	The ICFBamPubScopeObj instance referenced by the ScopeDef key.
	 */
	...
	/**
	 *	Set the ICFBamPubScopeObj instance referenced by the ScopeDef key.
	 *
	 *	@param	value	the ICFBamPubScopeObj instance to be referenced by the ScopeDef key.
	 */
	void set$OptionalOrRequired$ContainerScopeDef( ICFBamPubScopeObj value );
