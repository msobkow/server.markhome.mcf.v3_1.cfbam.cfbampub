// Description: Java 25 Object interface for CFBamPub Scope.
...
public interface ICFBamPubScopeObj
	extends ICFLibAnyObj
{
	/**
	 *	Initially, the class code for an object is ICFBamPubScope.CLASS_CODE, but the Obj layer relies on class code translation to map those
	 ...
	 *
	 *	@return	CFBamPubScopeObj instance which should be subsequently referenced.
	 */
	ICFBamPubScopeObj realise();
	 ...
	 *
	 *	@return	ICFBamPubScopeObj the reference to the cached or read (realised) instance.
	 */
	ICFBamPubScopeObj read();
	 ...
	 *	@return	ICFBamPubScopeObj the reference to the cached or read (realised) instance.
	 */
	ICFBamPubScopeObj read( boolean forceRead );

	/**
	 *	Initialize and return a locked edition of this Scope instance.
	 *
	 *	@return	The newly locked ICFBamPubScopeEditObj edition of this instance.
	 */
	ICFBamPubScopeEditObj beginEdit();
	 ...
	 *
	 *	@return	The ICFBamPubScopeEditObj edition of this instance.
	 */
	ICFBamPubScopeEditObj getEdit();

	/**
	 *	Get the current edition of this Scope instance as a ICFBamPubScopeEditObj.
	 *
	 *	@return	The ICFBamPubScopeEditObj edition of this instance.
	 */
	ICFBamPubScopeEditObj getEditAsScope();

	/**
	 *	Get the ICFBamPubScopeTableObj table cache which manages this instance.
	 *
	 *	@return	ICFBamPubScopeTableObj table cache which manages this instance.
	 */
	ICFBamPubScopeTableObj getScopeTable();
	...
	/**
	 *	Get the ICFBamPubScope instance which currently backs this instance.
	 *	<p>
	 *	This value <i>will</i> change for read-only instances, so you should
	 *	not hold on to the value as a reference anywhere outside the current call stack.
	 *
	 *	@return	ICFBamPubScope instance which currently backs this object.
	 */
	ICFBamPubScope getRec();

	/**
	 *	Internal use only.
	 */
	void setRec( ICFBamPubScope value );
