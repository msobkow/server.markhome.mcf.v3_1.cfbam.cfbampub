...
// Description: Java 25 public DbIO interface for BlobDef.
...
/*
 *	CFBamPubBlobDefTable public database interface for BlobDef has CodeVis Public, meaning that any user interface or referencing schema can access it.
 */
public interface ICFBamPubBlobDefTable
{
	 ...
	 *	@return	The refreshed record after it has been moved
	 */
	public ICFBamPubBlobDef pubmoveRecDown( ICFSecPubAuthorization Authorization,
		CFLibDbKeyHash256 Id,
		int revision );
}
