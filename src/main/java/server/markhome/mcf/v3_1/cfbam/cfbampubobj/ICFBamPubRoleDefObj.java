// Description: Java 25 Object interface for CFBamPub RoleDef.
...
public interface ICFBamPubRoleDefObj
	extends ICFLibAnyObj
{
	/**
	 *	Initially, the class code for an object is ICFBamPubRoleDef.CLASS_CODE, but the Obj layer relies on class code translation to map those
	 ...
	 *
	 *	@return	CFBamPubRoleDefObj instance which should be subsequently referenced.
	 */
	ICFBamPubRoleDefObj realise();
	 ...
	 *
	 *	@return	ICFBamPubRoleDefObj the reference to the cached or read (realised) instance.
	 */
	ICFBamPubRoleDefObj read();
	 ...
	 *	@return	ICFBamPubRoleDefObj the reference to the cached or read (realised) instance.
	 */
	ICFBamPubRoleDefObj read( boolean forceRead );

	/**
	 *	Initialize and return a locked edition of this RoleDef instance.
	 *
	 *	@return	The newly locked ICFBamPubRoleDefEditObj edition of this instance.
	 */
	ICFBamPubRoleDefEditObj beginEdit();
	 ...
	 *
	 *	@return	The ICFBamPubRoleDefEditObj edition of this instance.
	 */
	ICFBamPubRoleDefEditObj getEdit();

	/**
	 *	Get the current edition of this RoleDef instance as a ICFBamPubRoleDefEditObj.
	 *
	 *	@return	The ICFBamPubRoleDefEditObj edition of this instance.
	 */
	ICFBamPubRoleDefEditObj getEditAsRoleDef();

	/**
	 *	Get the ICFBamPubRoleDefTableObj table cache which manages this instance.
	 *
	 *	@return	ICFBamPubRoleDefTableObj table cache which manages this instance.
	 */
	ICFBamPubRoleDefTableObj getRoleDefTable();
	...
	/**
	 *	Get the ICFBamPubRoleDef instance which currently backs this instance.
	 *	<p>
	 *	This value <i>will</i> change for read-only instances, so you should
	 *	not hold on to the value as a reference anywhere outside the current call stack.
	 *
	 *	@return	ICFBamPubRoleDef instance which currently backs this object.
	 */
	ICFBamPubRoleDef getRec();

	/**
	 *	Internal use only.
	 */
	void setRec( ICFBamPubRoleDef value );
	 ...
	 *	@return	ICFBamPubRoleDef instance which currently backs this object.
	 */
	ICFBamPubRoleDef getRoleDefRec();
