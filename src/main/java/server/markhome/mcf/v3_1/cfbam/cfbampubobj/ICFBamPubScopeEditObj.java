// Description: Java 25 Public Instance Edit Object interface for CFBam Scope.
...
public interface ICFBamPubScopeEditObj
	extends ICFBamPubScopeObj
{
	/*
	 *	Get the original for this edition as the base type for the class hierarchy.
	 *
	 *	@return The original, non-modifiable instance as a base ICFBamPubScopeObj.
	 */
	ICFBamPubScopeObj getOrig();

	/*
	 *	Get the original for this edition cast as the specified type.
	 *
	 *	@return The original, non-modifiable instance cast to a ICFBamPubScopeObj.
	 */
	ICFBamPubScopeObj getOrigAsScope();
	 ...
	 */
	ICFBamPubScopeObj create();

	/*
	 *	Update the instance.
	 */
	ICFBamPubScopeEditObj update();

	/*
	 *	Delete the instance.
	 */
	ICFBamPubScopeEditObj deleteInstance();
