...
public interface ICFBamPubPopDepTableObj
{
	 ...
	 */
	ICFBamPubPopDepObj readPopDep( ICFLibKeyHash256 pkey );
	...
	ICFBamPubPopDepObj readCachedPopDep( ICFLibKeyHash256 pkey );
	 ...
	 *	Internal use only.
	 */
	ICFBamPubPopDepObj lockPopDep( ICFLibKeyHash256 pkey );
