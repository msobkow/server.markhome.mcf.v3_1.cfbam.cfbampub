// Description: Java 25 public interface for a Int16Type record implementation
...
/**
 *	ICFBamPubInt16Type persistence instances have CodeVis Public, meaning that any user interface or referencing schema can access it.
 */
public interface ICFBamPubInt16Type extends ICFBamPubInt16Def
{
