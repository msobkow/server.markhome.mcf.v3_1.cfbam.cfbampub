...
public interface ICFBamPubScopeTableObj
{
	 ...
	 */
	ICFBamPubScopeEditObj newEditInstance( ICFBamPubScopeObj orig );
	 ...
	 *
	 *	@return	ICFBamPubScopeObj instance, which may be a subclass of a Scope instance.
	 */
	ICFBamPubScopeObj constructByClassCode( int backingClassCode );

	/**
	 *	Internal use only.
	 */
	ICFBamPubScopeObj realiseScope( ICFBamPubScopeObj Obj );

	/**
	 *	Internal use only.
	 */
	ICFBamPubScopeObj createScope( ICFBamPubScopeObj Obj );
	 ...
	 *
	 *	@return	List of ICFBamPubScopeObj instance, sorted by their primary keys, which
	 *		may include an empty set.
	 */
	List<ICFBamPubScopeObj> readAllScope();
	 ...
	 *		may include an empty set.
	 */
	List<ICFBamPubScopeObj> readAllScope( boolean forceRead );

	List<ICFBamPubScopeObj> readCachedAllScope();
	 ...
	 */
	ICFBamPubScopeObj readScopeByIdIdx( CFLibDbKeyHash256 Id );
	 ...
	 *
	 *	@return	List of CFBamPubScopeObj cached instances sorted by their primary keys for the duplicate TenantIdx key,
	 *		which may be an empty set.
	 */
	List<ICFBamPubScopeObj> readScopeByTenantIdx( CFLibDbKeyHash256 TenantId );
	...
	ICFBamPubScopeObj readCachedScopeByIdIdx( CFLibDbKeyHash256 Id );

	List<ICFBamPubScopeObj> readCachedScopeByTenantIdx( CFLibDbKeyHash256 TenantId );
	 ...
	 *	Internal use only.
	 */
	ICFBamPubScopeObj updateScope( ICFBamPubScopeObj Obj );

	/**
	 *	Internal use only.
	 */
	void deleteScope( ICFBamPubScopeObj Obj );
