// Description: Java 25 public interface for a DoubleType record implementation
...
/**
 *	ICFBamPubDoubleType persistence instances have CodeVis Public, meaning that any user interface or referencing schema can access it.
 */
public interface ICFBamPubDoubleType extends ICFBamPubDoubleDef
{
