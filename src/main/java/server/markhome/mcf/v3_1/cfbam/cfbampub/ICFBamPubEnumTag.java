// Description: Java 25 public interface for a EnumTag record implementation
...
/**
 *	ICFBamPubEnumTag persistence instances have CodeVis Public, meaning that any user interface or referencing schema can access it.
 */
