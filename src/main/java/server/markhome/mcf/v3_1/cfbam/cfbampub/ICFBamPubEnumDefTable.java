...
// Description: Java 25 public DbIO interface for EnumDef.
...
/*
 *	CFBamPubEnumDefTable public database interface for EnumDef has CodeVis Public, meaning that any user interface or referencing schema can access it.
 */
public interface ICFBamPubEnumDefTable
{
