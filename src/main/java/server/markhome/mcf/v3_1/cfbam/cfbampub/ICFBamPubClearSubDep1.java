// Description: Java 25 public interface for a ClearSubDep1 record implementation
...
/**
 *	ICFBamPubClearSubDep1 persistence instances have CodeVis Public, meaning that any user interface or referencing schema can access it.
 */
public interface ICFBamPubClearSubDep1
	extends ICFBamPubClearDep
{
	...
	public ICFBamPubClearTopDep get$OptionalOrRequired$ContainerClearTopDep();
	...
	public List<ICFBamPubClearSubDep2> get$OptionalOrRequired$ComponentsClearDep();
