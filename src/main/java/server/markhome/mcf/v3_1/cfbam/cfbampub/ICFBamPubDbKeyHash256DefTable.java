...
// Description: Java 25 public DbIO interface for DbKeyHash256Def.
...
/*
 *	CFBamPubDbKeyHash256DefTable public database interface for DbKeyHash256Def has CodeVis Public, meaning that any user interface or referencing schema can access it.
 */
public interface ICFBamPubDbKeyHash256DefTable
{
	 ...
	 *	@return	The refreshed record after it has been moved
	 */
	public ICFBamPubDbKeyHash256Def pubmoveRecDown( ICFSecPubAuthorization Authorization,
		CFLibDbKeyHash256 Id,
		int revision );
}
